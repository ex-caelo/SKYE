...
import {
  ...
  toPickerEntries,
  type StepReporter,
} from "../features/switcher/siteSwitcher.js";
import { showConfirmDialog } from "../shared/ui/confirmDialog.js";
import { showState } from "../shared/ui/pageState.js";
import { ensureInvokerCommands } from "../shared/ui/invokers.js";
import { SkyeInstallError, type SiteResult } from "../shared/sharepoint/types.js";
import {
