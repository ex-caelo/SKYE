...
import { getFieldSchemaProperties, getPageSchemaProperties, type SchemaProperty } from "@skye/config";
import { renderObjectEditor, renderPropertyControl } from "../lib/builder/schemaControls.js";
