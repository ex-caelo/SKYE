import type { SchemaProperty } from "@skye/config";
import { classifySchemaProperty } from "@skye/config";
 ...
 * @skye/config's schemaIntrospection) and the plain JS object that owns
